...
def etl_customer_voucher_assignment_with_spark():
    args = [
        "--domain",
        "customer",
        "--dataset",
    ...
    etl_task = SparkSubmitOperator(
        task_id="spark_etl",
        application="local:///opt/application/src/etl/main.py",
    ...
    sleep >> etl_task >> prepare_warehouse >> load_to_warehouse >> generate_segmentation_views


dag = etl_customer_voucher_assignment_with_spark()
